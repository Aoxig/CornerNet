...
class NWPU(DETECTION):
    def __init__(self, db_config, split):
        super(NWPU, self).__init__(db_config)
        ...
        self._coco_dir = os.path.join(data_dir, "nwpu")
        ...
        self._cache_file = os.path.join(cache_dir, "npwu_{}.pkl".format(self._dataset))
        self._load_data()
